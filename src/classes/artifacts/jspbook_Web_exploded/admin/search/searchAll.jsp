...
<head>
    ...
    <script language="javascript">
        function rateForC(id)
        {
            if(confirm('Useless, Useful, or very Useful?'))
            {
                window.location.href="<%=path %>/book?type=bookDel&id="+id;
            }
        }

        function trustful(id)
        {
            if(confirm('Trusted or untrusted?'))
            {
                window.location.href="<%=path %>/book?type=bookDel&id="+id;
            }
        }
...
<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#BBC9E8" align="center" style="margin-top:8px">
    <tr bgcolor="#E7E7E7">
        <td height="14" colspan="10"  class='title'>&nbsp;Search Result&nbsp;</td>
    </tr>
...
<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#BBC9E8" align="center" style="margin-top:8px">
    <tr bgcolor="#E7E7E7">
        <td height="14" colspan="10"  class='title'>&nbsp;Comment&nbsp;</td>
    </tr>
    <tr align="center" bgcolor="#FFFFFF" height="22">
        <td width="25%">Short text</td>
        <td width="10%">Scores</td>
        <td width="10%">User ID</td>
        <td width="10%">Trustfulness</td>
        <td width="10%">Usefulness</td>
        <td width="10%">Publication Date</td>
        <td width="10%">ISBN</td>
    ...
    <c:forEach items="${requestScope.bookList}" var="book">
        <tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
            ...
            <td bgcolor="#FFFFFF" align="center">
                    ${comment.trustfulness }
            </td>

            <td bgcolor="#FFFFFF" align="center">
                <a href="#" onclick="rateForC(${book.id })" class="pn-loperator">Rate for Comment</a>
                <a href="#" onclick="trustful(${book.id })" class="pn-loperator">Trustful or Not</a>
            </td>
